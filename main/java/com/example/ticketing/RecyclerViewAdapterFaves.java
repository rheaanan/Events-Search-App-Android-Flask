...
public class RecyclerViewAdapterFaves extends RecyclerView.Adapter<RecyclerViewAdapterFaves.MyViewHolder> {
    List<EventDetails> eventDetailsList;
    String category_list;
    Context context;
    private RequestQueue mQueue;

    public RecyclerViewAdapterFaves(List<EventDetails> eventList, Context context) {
    ...
    @NotNull
    @Override
    public RecyclerViewAdapterFaves.MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.one_event,parent,false);
        RecyclerViewAdapterFaves.MyViewHolder holder = new RecyclerViewAdapterFaves.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull RecyclerViewAdapterFaves.MyViewHolder holder, int position) {
        ...
        holder.iv_fav_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                eventDetailsList.remove(position);
                notifyItemRemoved(position);
                notifyItemRangeChanged(position,eventDetailsList.size());
